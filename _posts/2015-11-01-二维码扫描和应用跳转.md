...
##序言
前面我们已经调到过怎么[制作二维码](http://www.jianshu.com/p/d90cd2cb41d7)，在我们能够生成二维码之后，如何对二维码进行扫描呢？
...
这里我们使用上面设置的url scheme，我们通过[制作二维码](http://www.jianshu.com/p/d90cd2cb41d7)方法来定制一个存储应用跳转信息的二维码，通过下面的代理创建一个存储url scheme(***使用url scheme的时候要注意在后面加上://后才能使用openURL进行跳转***)的二维码，这一步应该放到模拟器上面生成
...
个人主页：[sindrilin.com](http://www.sindrilin.com)

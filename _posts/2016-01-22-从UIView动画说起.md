...
![动效](http://upload-images.jianshu.io/upload_images/783864-40e1c72972901f61.gif?imageMogr2/auto-orient/strip)
*ps: 本文的内容主要为iOS开发的动画入门*
...
![界面动画](http://upload-images.jianshu.io/upload_images/783864-f7392e407a179103.gif?imageMogr2/auto-orient/strip)
在这段动画之中发生的最为明显的事情就是两个文本框的位置变化，在动画开始之前，两个文本框的位置应该是在屏幕的左边，而下方的按钮现在是隐藏状态（设置alpha）

![动画开始前](http://upload-images.jianshu.io/upload_images/783864-98346687bec9c8b2.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![尺寸修改](http://upload-images.jianshu.io/upload_images/783864-932646cc632d1cb8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

####视图显示类
- backgroundColor: 修改这个属性会产生颜色渐变过渡的效果，本质上是系统不断修改了tintColor来实现的
- alpha：修改这个属性会产生淡入淡出的效果
- hidden：修改这个属性可以制作翻页隐藏的效果
![修改透明度](http://upload-images.jianshu.io/upload_images/783864-eae419dcf9a6e1a4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)

####形态变化类
- transform：修改这个属性可以实现旋转、形变、移动、翻转等动画效果，其通过矩阵运算的方式来实现，因此更加强大
![旋转](http://upload-images.jianshu.io/upload_images/783864-8046ca462857698f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![重复的动画](http://upload-images.jianshu.io/upload_images/783864-b2274177fcd08ea2.gif?imageMogr2/auto-orient/strip)
...
![汽车的加速减速.png](http://upload-images.jianshu.io/upload_images/783864-fc0a0cddd78e2ef8.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![四种线性速度表示](http://upload-images.jianshu.io/upload_images/783864-cb51006d5e0591e8.gif?imageMogr2/auto-orient/strip)
...
![翻卡匹配小游戏](http://upload-images.jianshu.io/upload_images/783864-6e912a7dd4014a8b.gif?imageMogr2/auto-orient/strip)
在模拟器下使用`command+T`放慢了动画的速度之后，我截取了翻转的四张图片：
![慢动作翻转](http://upload-images.jianshu.io/upload_images/783864-b54bde7a506db33f.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![小球弹出效果](http://upload-images.jianshu.io/upload_images/783864-06082d3c3b2c7cf7.gif?imageMogr2/auto-orient/strip)
...
![弹出的登录按钮](http://upload-images.jianshu.io/upload_images/783864-99367aaee32cccf5.gif?imageMogr2/auto-orient/strip)
